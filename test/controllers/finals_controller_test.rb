...
class FinalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create final" do
    assert_difference('Final.count') do
      post finals_url, params: { final: { email: @final.email, integer: @final.integer, namestring: @final.namestring, string: @final.string, suff: @final.suff } }
    end
  ...
  test "should update final" do
    patch final_url(@final), params: { final: { email: @final.email, integer: @final.integer, namestring: @final.namestring, string: @final.string, suff: @final.suff } }
